...
\begin{frame}[fragile]
	...
	{\tiny \href{https://en.wikipedia.org/wiki/Michael_Stonebraker}{Michael Stonebraker}}
\end{frame}
...
\begin{frame}
	\frametitle{Go Big or Nothing}
	\includegraphics[height=0.8\paperheight]{image/vibe}
\end{frame}

\begin{frame}
	\frametitle{本周任务}
	\begin{itemize}
		\item 安装DuckDB；PG 和 DataGrip
		\item 看书了解数据库的发展历史
	...
	\begin{itemize}
		\item \faIcon{windows} Windows：从 EDB 下载\href{https://www.enterprisedb.com/downloads/postgres-postgresql-downloads}{安装包}或\href{https://www.enterprisedb.com/download-postgresql-binaries}{二进制包}。（建议通过\texttt{WSL}使用\texttt{Docker}安装)
