...
\begin{frame}
  ...
  {\tiny 类型总结：\url{https://duckdb.org/docs/stable/sql/data_types/overview}、\url{https://www.postgresql.org/docs/current/datatype.html}}
\end{frame}
...
\begin{frame}
	...
	确保安装DuckDB、PG和DataGrip软件，并下载GitHub上的SQL代码，为下周的实验课做好准备。
