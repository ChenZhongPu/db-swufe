...
\begin{frame}[fragile]
	\frametitle{资源}
	PG 中的字符串操作异常丰富，可以参考 \href{https://www.postgresql.org/docs/17/functions-string.html}{String Functions and Operators} 和 \href{https://www.postgresql.org/docs/17/functions-matching.html}{Pattern Matching}。
